...
const docTemplate = `{
    ...
    "info": {
        ...
        "contact": {
            "name": "Claran API Support",
            "url": "https://github.com/Claran309",
            "email": "claran.ran.away@gmail.com"
        },
        "license": {
            "name": "Apache 2.0",
    ...
    "paths": {
        ...
        "/admin/ban_user/recover": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "解封用户请求参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.RecoverUserRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/op/deprive": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "撤销管理员权限请求参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.DepriveAdminRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/admin/op/give": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "授予管理员权限请求参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.GiveAdminRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.SearchFileRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/share/create": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "创建分享请求参数",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.CreateShareRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/share/{unique_id}/{file_id}/download": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.GetVerificationCodeRequest"
                        }
                    }
                ],
                "responses": {
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/model.VerifyVerificationCodeRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "model.GetVerificationCodeRequest": {
        ...
        "model.LoginRequest": {
            ...
            "properties": {
                "login_key": {
                    "type": "string",
                    "example": "john_doe或john@example.com"
                },
                "password": {
                    "type": "string",
                    "example": "password123"
